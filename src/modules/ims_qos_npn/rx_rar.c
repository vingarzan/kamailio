 ...
 * $Id$
 *
 * Copyright (C) 2024 Neat Path Networks GmbH, alberto.diez@neatpath.net
 * Copyright (C) 2024 Neat Path Networks GmbH, dragos.vingarzan@neatpath.net
 * 
 ...
 * file
 * Events supported are Access-Network-Information, LOSS_OF_BEARER, RECOVERY_OF_BEARER
