...
CREATE TABLE `dialplan` (
  ...
  `match_op` int(11) DEFAULT NULL,
  `match_exp` varchar(512) DEFAULT NULL,
  `match_len` int(11) DEFAULT NULL,
  `subst_exp` varchar(512) DEFAULT NULL,
  `repl_exp` varchar(512) DEFAULT NULL,
  `attrs` varchar(512) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `messages` (
  ...
  `text` blob,
  `valid` varchar(256) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2016-05-18 18:24:22
-- MySQL dump 10.13  Distrib 5.7.12, for Linux (x86_64)
--
-- Host: localhost    Database: scscf_db
-- ------------------------------------------------------
...
INSERT INTO `dialplan` VALUES (1,1,4,1,'^00([1-9][0-9]+)$',0,'^00([1-9][0-9]+)$','+\\1','');
INSERT INTO `dialplan` VALUES (2,1,3,1,'^0([1-9][0-9]+)$',0,'^0([1-9][0-9]+)$','+49\\1','');
INSERT INTO `dialplan` VALUES (3,1,2,1,'^11([0-9]+)$',0,'^11([0-9]+)$','+4911\\1','');
INSERT INTO `dialplan` VALUES (4,1,1,1,'^([1-9][0-9]+)$',0,'^([1-9][0-9]+)$','+\\1','');
...
grant delete,insert,select,update on scscf_db.* to provisioning@'192.168.%' identified by 'provi';
